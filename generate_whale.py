#!/usr/bin/env python3
# generate_whale.py - Cria examples/whale_detection.py
code = '''#!/usr/bin/env python3
"""Pipeline de detec??o de vocaliza??es de baleia-azul."""
...
if __name__ == "__main__":
    ...
    print("?? Detec??o de Baleia-Azul ? HMAL")
...
'''
with open("examples/whale_detection.py", "w", encoding="utf-8") as f:
    f.write(code)
print("OK: examples/whale_detection.py criado")
